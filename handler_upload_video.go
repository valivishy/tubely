...
func (cfg apiConfig) handlerUploadVideo(w http.ResponseWriter, r *http.Request) {
	...
	if err = cfg.uploadVideoToS3(r.Context(), tempFile, mediaType, filename); err != nil {
		respondWithError(w, http.StatusInternalServerError, unableToUploadVideo, err)
		return
	}
...
func (cfg apiConfig) uploadVideoToS3(ctx context.Context, file *os.File, mediaType, filename string) error {
